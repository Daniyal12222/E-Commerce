...
var data = [
    ...
    },
    {
        ...
        shippingInformation: "Ships overnight",
        availabilityStatus: "In Stock",
        images:'img/pngegg.png',
        thumbnail:'img/pngegg.png',
        reviews: [
            {
                rating: 4,
                comment: "Fast shipping!",
...
for (const x of data) {
    if (!unic.includes(x.category)) {
        drop.innerHTML += `<option value="${x.category}" class="font-sarif p-3">${x.category}</option>`
        unic.push(x.category)
    }
}
let main = document.getElementById('main')
//  card //
for (const t of data) {
        main.innerHTML += ` <div class="card justify-between flex flex-col gap-3 p-3 "><img src="${t.thumbnail}" alt="" class="w-full rounded-[10px]">
    <h3 class="font-bold text-red-500 font-serif">Title : <p class="inline text-red-700 font-thin ms-4">${t.title.slice(0,17)}</p></h3>
    <h3 class="font-bold text-red-500 font-serif">Category : <p class="inline text-red-700 font-thin ms-5">${t.category.slice(0,1).toLocaleUpperCase()}${t.category.slice(1)}</p></h3>
    <h3 class="font-bold text-red-500 font-serif">Rating : <p class="inline text-red-700 font-thin ms-5">${t.reviews[0].rating}</p></h3>
    <h3 class="font-bold text-red-500 font-serif">Date : <p class="inline text-red-700 font-thin ms-5">${t.reviews[0].date.slice(0,7)}</p></h3>
    <button class="button" onclick="buy(${t.id -1})">
        <span >Buy now</span>
    </button>
...
function card() {
    main.innerHTML = ''
    for (const y of data) {
        if (y.category == drop.value) {
            
            main.innerHTML += ` <div class="card justify-between flex flex-col gap-3 p-3 "><img src="${y.thumbnail}" alt="" class="w-full rounded-[10px]">
        <h3 class="font-bold text-red-500 font-serif">Title : <p class="inline text-red-700 font-thin ms-5">${y.title}</p></h3>
            <h3 class="font-bold text-red-500 font-serif">Category : <p class="inline text-red-700 font-thin ms-5">${y.category.slice(0,1).toLocaleUpperCase()}${y.category.slice(1)}</p></h3>
        <h3 class="font-bold text-red-500 font-serif">Rating : <p class="inline text-red-700 font-thin ms-5">${y.reviews[0].rating}</p></h3>
        <h3 class="font-bold text-red-500 font-serif">Date : <p class="inline text-red-700 font-thin ms-5">${y.reviews[0].date.slice(0,7)}</p></h3>
        <button class="button" onclick="buy(${y.id -1})">
            <span >Buy now</span>
        </button>
...
function buy(i) {
    // Swal.fire(`<div class="img w-full h-[300px] flex justify-center "><img src="${data[i].images}" alt="" class=' w-[300px] h-[300px] '></div><h1>${data[i].title}</h1> `);
    alertify.confirm(`<div class="img   flex justify-between items-center flex-col  "><img src="${data[i].images}" alt="" class=' w-[300px] h-[300px] '><h1>${data[i].title}</h1><h1>${data[i].description}</h1></div> `,
        function(){
          alertify.success('Ok');
        },
        function(){
